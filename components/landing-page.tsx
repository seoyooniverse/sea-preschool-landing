    ...
    <main className="relative min-h-screen overflow-hidden bg-ink text-bone">
      ...
      <SectionShell>
        <Reveal>
          ...
          <h2 className="max-w-[680px] text-[clamp(2.2rem,5vw,5rem)] font-black leading-[1.08]">
            <span className="block">매주 하나씩,</span>
            <span className="block">내 포트폴리오를 채웁니다.</span>
          </h2>
        </Reveal>
      ...
      <SectionShell id="curriculum" className="border-y border-line">
        <Reveal>
          ...
          <h2 className="max-w-[720px] text-[clamp(2.2rem,5vw,5rem)] font-black leading-[1.08]">
            <span className="block">시장 분석부터 최종 발표까지,</span>
            <span className="block">하나의 데뷔 프로젝트처럼.</span>
          </h2>
        </Reveal>
      ...
      <SectionShell id="price" className="border-y border-line">
        <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          <Reveal>
            ...
            <h2 className="text-[clamp(2rem,4.8vw,4.8rem)] font-black leading-[1.1] [word-break:keep-all]">
              <span className="block">가격은 가볍게,</span>
              <span className="block">혜택은 확실하게.</span>
            </h2>
          </Reveal>
          <Reveal delay={0.08}>
