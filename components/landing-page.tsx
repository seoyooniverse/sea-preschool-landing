...
function CTA({ href = "/apply", children, variant = "primary" }: { href?: string; children: React.ReactNode; variant?: "primary" | "secondary" }) {
  return (
    <a
      href={href}
      className={[
        "group inline-flex min-h-14 min-w-[148px] items-center justify-center gap-2 whitespace-nowrap rounded-full px-8 text-base font-bold outline-none transition duration-300 focus-visible:ring-2 focus-visible:ring-signal focus-visible:ring-offset-2 focus-visible:ring-offset-ink",
        variant === "primary"
